...
# Load data
train_dataset = MoleculeDataset(root=r"C:\Users\kesha\Desktop\GVAE\data", filename="PI_DATA_train.csv")[:2000]
test_dataset = MoleculeDataset(root=r"C:\Users\kesha\Desktop\GVAE\data", filename="PI_DATA_test.csv", test=True)[:1000]
...
def run_one_epoch(data_loader, type, epoch, kl_beta):
    ...
    # Perform sampling
    if type == "Test":
        generated_mols = model.sample_mols(num=2000)
